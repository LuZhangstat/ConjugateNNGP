...
setwd("./asym_sim/data/simdata_5")
rm(list = ls())
source("../NNMatrix.R")
load("simdata_5.RData")
...
save(list = ls(all.names = TRUE), file = "nngp_5_5.RData", envir = .GlobalEnv)

#save(list = ls(all.names = TRUE), file = "nngp_10_5.RData", envir = .GlobalEnv)
