...
setwd("./asym_sim/data/simdata_2")
rm(list = ls())
source("../NNMatrix.R")
load("simdata_2.RData")
...
save(list = ls(all.names = TRUE), file = "nngp_5_2.RData", envir = .GlobalEnv)

#save(list = ls(all.names = TRUE), file = "nngp_10_2.RData", envir = .GlobalEnv)
